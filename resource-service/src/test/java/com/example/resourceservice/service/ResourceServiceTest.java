...
class ResourceServiceTest {
    ...
    void uploadResource_success() {
        ...
        org.mockito.Mockito.when(storageService.prepareFileUrl(org.mockito.Mockito.anyString())).thenReturn("fileUrl");
        org.mockito.Mockito.doNothing().when(storageService).addFileBytesToStorage(org.mockito.Mockito.anyString(), org.mockito.Mockito.any());
    ...
    void uploadResource_storageException() {
        ...
        org.mockito.Mockito.doThrow(new RuntimeException()).when(storageService).addFileBytesToStorage(org.mockito.Mockito.anyString(), org.mockito.Mockito.any());
    ...
    void getFileAsBytes_success() {
        ...
        org.mockito.Mockito.when(storageService.retrieveFileFromStorage("key")).thenReturn(responseBytes);
