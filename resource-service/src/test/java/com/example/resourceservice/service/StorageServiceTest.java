...
//        assertDoesNotThrow(() -> storageService.addFileBytesToStorage("key123", bytes, "test-bucket"));
...
//                () -> storageService.addFileBytesToStorage("key123", bytes, "test-bucket"));
//        assertNotNull(ex);
//    }
//
//    @Test
...
//
//        ResponseBytes<GetObjectResponse> result = storageService.retrieveFileFromStorage("key123", "test-bucket");
...
//
//        StorageException ex = assertThrows(StorageException.class,
//                () -> storageService.retrieveFileFromStorage("key123", "test-bucket"));
//        assertNotNull(ex);
//    }
//
//    @Test
...
//        byte[] bytes = new byte[]{1,2,3};
//        assertDoesNotThrow(() -> storageService.recoverDeletedFileToStorage("key123", bytes, "test-bucket"));
//        verify(s3Client).putObject(any(PutObjectRequest.class), any(RequestBody.class));
//    }
//
//    @Test
...
//
//        StorageException ex = assertThrows(StorageException.class,
//                () -> storageService.recoverDeletedFileToStorage("key123", bytes, "test-bucket"));
//        assertNotNull(ex);
//    }
//
//    @Test
//    void testDeleteResourceFromStorage_success() {
//        assertDoesNotThrow(() -> storageService.deleteResourceFromStorage("key123", "test-bucket"));
...
//
//        StorageException ex = assertThrows(StorageException.class,
//                () -> storageService.deleteResourceFromStorage("key123", "test-bucket"));
//        assertNotNull(ex);
//            }
//
//    @Test
//    void testPrepareFileUrl() {
//        StorageMetadataResponse metadataResponse = new StorageMetadataResponse();
//        metadataResponse.setBucket("test-bucket");
//        metadataResponse.setPath("");
//        String url = storageService.prepareFileUrl("key123", metadataResponse);
